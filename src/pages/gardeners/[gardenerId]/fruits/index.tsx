...
const GardenerFruitsDetails: NextPageWithLayout = (): React.ReactElement => {
...
GardenerFruitsDetails.getLayout = function getLayout(page: React.ReactElement) {
  return (
    <DefaultLayout>
...
export default GardenerFruitsDetails;
